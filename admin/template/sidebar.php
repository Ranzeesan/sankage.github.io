...
<aside>
    <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <p class="centered"><a><img src="assets/img/user/<?php echo $hasil['gambar']; ?>" class="img-circle" width="100" height="110"></a></p>
            <h5 class="centered"><?php echo $hasil['nm_member']; ?></h5>
            <h5 class="centered">( <?php echo $hasil['NIK']; ?> )</h5>
